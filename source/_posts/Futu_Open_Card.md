...
| 众安银行   | ✅      | <button style=<br/>        "background-color: blue; <br/>        color: white;" onclick="navigator.clipboard.writeText('JT78T4')">JT78T4</button> | 5w | [ZA_BANK](https://bank.za.group/hk) | 开户不送钱                        |
...
| 招商永隆银行 | ❌      | <button style=<br/>        "background-color: blue; <br/>        color: white;" onclick="navigator.clipboard.writeText('CMH42N9955')">CMH42N9955</button> | 3w        |         | 需要存1w 港币，但是app很好用跟招行一样                                                    |
| 渣打银行   | ❌      | /          |           |           | 要存100w或买保险，不推荐                                                            |
