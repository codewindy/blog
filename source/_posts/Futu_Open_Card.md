...
| 类型 | 是否推荐   | 优点 | 缺点 |
|----| -------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| 线上 | ❌      | 1. 线上开户不需要地址证明，直接在香港连接WiFi即可开户<br />2. 开户30分钟内搞定 | 1. <span style="color:black; font-weight:bold;background:yellow">20241109 更新中银香港线上开户必须签字否则很多功能不能用只能存钱不能 取钱不能修改限额等</span><br />2. 额度低日转账额度10w/天随便到一个网点签字后可以提额度到100w/天<br />3. 现场无实体卡，但寄送到大陆<br />4. 适合学历稍微好一些本科以上 |
